  ...
  const contacts = [
    {
      ...
      email: "l.bianchi@meridian-eng.example.com",
      linkedin_url: "https://linkedin.com/in/luca-bianchi",
    ...
    },
    {
      ...
      role: "Safety Lead",
      email: "anna.lindstrom@nordic-auto.example.com",
      linkedin_url: "https://linkedin.com/in/ingrid-dahl-safety",
      source: "referral",
      score: 90,
      stage: "proposal",
    ...
    },
    {
      ...
      email: "t.keller@example-atlas.com",
      linkedin_url: "https://linkedin.com/in/thomas-keller-atlas",
      source: "web_intel",
      score: 55,
      stage: "prospect",
    ...
    },
    {
      ...
      role: "SW Team Lead",
      email: "mihai.popov@zentral-auto.example.com",
      linkedin_url: "https://linkedin.com/in/mihai-popov-zentral",
      source: "linkedin_scrape",
      score: 40,
      stage: "contacted",
  ...
  if (existingDocs.n === 0) {
    const docs = [
      ...
      },
      {
        ...
        title: "Nordic Auto: ASIL-D E/E architecture safety analysis — 12-week engagement",
        content:
